...
public class GetTimeMain {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("SECOND_OF_MINUTE = " + dt.get(ChronoField.SECOND_OF_MINUTE)); // 50
        ...
        System.out.println("SECOND_OF_MINUTE = " + dt.getSecond()); // 50

        System.out.println("편의 메서드에 없음");
        System.out.println("MINUTE_OF_DAY = " + dt.get(ChronoField.MINUTE_OF_DAY)); // 810 (하루에 있는 시간)
        System.out.println("SECOND_OF_DAY = " + dt.get(ChronoField.SECOND_OF_DAY)); // 48650 (하루에 있는 초)
    }
}
